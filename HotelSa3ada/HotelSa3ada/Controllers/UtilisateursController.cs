...
namespace HotelSa3ada.Controllers
{
    public class UtilisateursController : Controller
    {
        ...
        public UtilisateursController(Hotelsa3adaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdUtilisateur,Nom,Role")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUtilisateur,Nom,Role")] Utilisateur utilisateur)
        {
